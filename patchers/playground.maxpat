		...
		"boxes": [
			{
				"box": {
					...
					"numoutlets": 1,
					"outlettype": [""],
					"patching_rect": [230.0, 36.0, 54.0, 22.0],
					"text": "deferlow"
				}
			},
			{
				"box": {
					...
					"numoutlets": 2,
					"outlettype": ["int", "bang"],
					"patching_rect": [230.0, 63.0, 37.0, 22.0],
					"text": "t 1 b"
				}
			},
			{
				"box": {
					...
					"numoutlets": 1,
					"outlettype": [""],
					"patching_rect": [248.0, 91.0, 121.0, 22.0],
			...
			},
			{
				"box": {
					...
					"numoutlets": 1,
					"outlettype": ["bang"],
					"patching_rect": [79.0, 63.0, 63.0, 22.0],
					"text": "closebang"
				}
			},
			{
				"box": {
					...
					"numoutlets": 1,
					"outlettype": [""],
					"patching_rect": [79.0, 91.0, 144.0, 22.0],
			...
			},
			{
				"box": {
					...
					"numoutlets": 1,
					"outlettype": ["bang"],
					"patching_rect": [230.0, 11.0, 58.0, 22.0],
					"text": "loadbang"
				}
			},
			{
				"box": {
					...
					"numoutlets": 1,
					"outlettype": ["bang"],
					"patching_rect": [12.0, 63.0, 61.0, 22.0],
					"text": "savebang"
				}
			},
			{
				"box": {
					...
					"numoutlets": 1,
					"outlettype": [""],
					"patching_rect": [12.0, 91.0, 45.0, 22.0],
					"text": "store 1"
				}
			},
			{
				"box": {
					...
					"numoutlets": 1,
					"outlettype": [""],
					"patching_rect": [12.0, 128.0, 202.0, 22.0],
					"saved_object_attributes": {
		...
		"lines": [
			...
			},
			{
				"patchline": {
					...
					"hidden": 1,
					"midpoints": [257.5, 120.5, 21.5, 120.5],
					"source": ["obj-35", 0]
				}
			},
			{
			...
			},
			{
				"patchline": {
					"destination": ["obj-39", 0],
					"hidden": 1,
					"midpoints": [239.5, 120.5, 21.5, 120.5],
					"source": ["obj-40", 0]
				}
			},
			{
				"patchline": {
					"destination": ["obj-39", 0],
					"hidden": 1,
					"midpoints": [88.5, 120.5, 21.5, 120.5],
					"source": ["obj-42", 0]
				}
			},
			{
