	...
	"patcher": {
		...
		"boxes": [
			{
				"box": {
						...
						"boxes": [
							...
							},
							{
								"box": {
									...
									"patching_rect": [348.360647201538086, 158.196719646453857, 29.5, 22.0],
									"text": "t b f"
								}
							},
							{
							...
							},
							{
								"box": {
									...
									"outlettype": ["float"],
									"patching_rect": [
										69.672130584716797, 303.278682708740234, 380.485645771026611, 22.0
									],
									"text": "gen hex-fuzz"
								}
							},
							...
							},
							{
								"box": {
									...
									"numoutlets": 1,
									"outlettype": [""],
									"patching_rect": [348.3606235354614, 39.99999599752806, 30.0, 30.0]
								}
							},
							{
								"box": {
						...
						"lines": [
							...
							},
							{
								"patchline": {
									"destination": ["obj-118", 0],
									"midpoints": [
										357.860647201538086, 199.024587631225586, 59.5, 199.024587631225586
									],
									"source": ["obj-121", 0]
								}
							},
							...
							},
							{
								"patchline": {
									"destination": ["obj-76", 0],
									"midpoints": [
										79.172130584716797, 332.090150356292725, 59.5, 332.090150356292725
									],
									"source": ["obj-91", 0]
								}
							},
					...
					"patching_rect": [351.0, 430.666679501533508, 61.0, 22.0],
			...
			},
			{
				"box": {
					...
					"patching_rect": [489.666670799255371, 430.666679501533508, 82.0, 22.0],
					"saved_object_attributes": {
						"description": "",
						"digest": "",
						"globalpatchername": "",
			...
			},
			{
				"box": {
					...
					"numoutlets": 1,
					"outlettype": ["float"],
					"patching_rect": [542.0, 98.0, 25.0, 22.0],
					"text": "t 0."
				}
			},
			{
				"box": {
					...
					"outlettype": ["", "float"],
					"parameter_enable": 1,
					"patching_rect": [542.0, 132.0, 50.0, 65.0],
					"presentation": 1,
					"presentation_rect": [175.0, 100.0, 65.0, 65.0],
			...
			},
			{
				"box": {
					...
					"numoutlets": 1,
					"outlettype": ["float"],
					"patching_rect": [1004.000000000000114, 98.0, 32.0, 22.0],
					"text": "t 50."
				}
			},
			{
				"box": {
					...
					"numoutlets": 1,
					"outlettype": ["signal"],
					"patching_rect": [888.000000000000114, 250.0, 58.0, 22.0],
					"text": "mc.sum~"
				}
			},
			{
				"box": {
					...
					"numoutlets": 1,
					"outlettype": ["signal"],
					"patching_rect": [850.000000000000114, 250.0, 31.0, 22.0],
					"text": "sig~"
				}
			},
			{
				"box": {
					...
					"numoutlets": 1,
					"outlettype": ["multichannelsignal"],
					"patching_rect": [813.000000000000114, 278.0, 94.0, 49.0],
					"text": "mc.gen~ number-input @chans 6"
				}
			},
			{
				"box": {
					...
					"numoutlets": 1,
					"outlettype": [""],
					"patching_rect": [813.000000000000114, 204.0, 30.0, 30.0]
				}
			},
			{
				"box": {
					...
					"numoutlets": 1,
					"outlettype": ["float"],
					"patching_rect": [850.000000000000114, 98.0, 45.0, 22.0],
					"text": "t 2000."
				}
			},
			{
			...
			},
			{
				"box": {
					...
					"outlettype": ["int", "", ""],
					"parameter_enable": 0,
					"patching_rect": [197.0, 219.0, 100.0, 20.0],
					"presentation": 1,
			...
			},
			{
				"box": {
					...
					"numoutlets": 1,
					"outlettype": ["float"],
					"patching_rect": [1004.000000000000114, 212.0, 39.0, 22.0],
					"text": "/ 100."
				}
			},
			{
			...
			},
			{
				"box": {
					...
					"outlettype": ["", "float"],
					"parameter_enable": 1,
					"patching_rect": [1004.000000000000114, 130.0, 50.0, 65.0],
					"presentation": 1,
					"presentation_rect": [270.0, 100.0, 65.0, 65.0],
					"saved_attribute_attributes": {
						"activedialcolor": {
							"expression": ""
						},
			...
			},
			{
				"box": {
					...
					"numinlets": 1,
					"numoutlets": 0,
					"patching_rect": [1393.0, 11.0, 74.0, 18.0],
					"presentation": 1,
			...
			},
			{
				"box": {
					...
					"numoutlets": 1,
					"outlettype": ["signal"],
					"patching_rect": [734.000000000000114, 250.0, 58.0, 22.0],
					"text": "mc.sum~"
				}
			},
			{
				"box": {
					...
					"numoutlets": 1,
					"outlettype": ["signal"],
					"patching_rect": [696.000000000000114, 250.0, 31.0, 22.0],
					"text": "sig~"
				}
			},
			{
				"box": {
					...
					"numoutlets": 1,
					"outlettype": ["multichannelsignal"],
					"patching_rect": [659.000000000000114, 278.0, 94.0, 49.0],
					"text": "mc.gen~ number-input @chans 6"
				}
			},
			{
			...
			},
			{
				"box": {
					...
					"numoutlets": 1,
					"outlettype": ["signal"],
					"patching_rect": [1042.0, 250.0, 58.0, 22.0],
					"text": "mc.sum~"
				}
			},
			{
				"box": {
					...
					"numoutlets": 1,
					"outlettype": ["signal"],
					"patching_rect": [1004.000000000000114, 250.0, 31.0, 22.0],
					"text": "sig~"
				}
			},
			{
				"box": {
					...
					"numoutlets": 1,
					"outlettype": ["multichannelsignal"],
					"patching_rect": [967.000000000000114, 278.0, 94.0, 49.0],
					"text": "mc.gen~ number-input @chans 6"
				}
			},
			{
				"box": {
					...
					"numoutlets": 1,
					"outlettype": [""],
					"patching_rect": [659.000000000000114, 204.0, 30.0, 30.0]
				}
			},
			{
				"box": {
					...
					"numoutlets": 1,
					"outlettype": ["float"],
					"patching_rect": [696.000000000000114, 98.0, 32.0, 22.0],
					"text": "t 0.5"
				}
			},
			{
			...
			},
			{
				"box": {
					...
					"numoutlets": 1,
					"outlettype": [""],
					"patching_rect": [967.000000000000114, 204.0, 30.0, 30.0]
				}
			},
			{
				"box": {
			...
			},
			{
				"box": {
					...
					"outlettype": ["", "float"],
					"parameter_enable": 1,
					"patching_rect": [388.0, 132.0, 50.0, 65.0],
					"presentation": 1,
			...
			},
			{
				"box": {
					...
					"outlettype": ["", "float"],
					"parameter_enable": 1,
					"patching_rect": [696.000000000000114, 132.0, 50.0, 65.0],
					"presentation": 1,
			...
			},
			{
				"box": {
					...
					"outlettype": ["", "float"],
					"parameter_enable": 1,
					"patching_rect": [850.000000000000114, 132.0, 50.0, 65.0],
					"presentation": 1,
		...
		"lines": [
			...
			},
			{
				"patchline": {
					"destination": ["obj-27", 0],
					"midpoints": [976.500000000000114, 241.393443584442139, 1051.5, 241.393443584442139],
					"order": 0,
					"source": ["obj-32", 0]
				}
			},
			...
			},
			{
				"patchline": {
					"destination": ["obj-48", 0],
					"midpoints": [
						668.500000000000114, 242.131145477294922, 743.500000000000114, 242.131145477294922
					],
					"order": 0,
					"source": ["obj-33", 0]
				}
			...
			},
			{
				"patchline": {
					"destination": ["obj-2", 0],
					"midpoints": [
						822.500000000000114, 242.131145477294922, 897.500000000000114, 242.131145477294922
					],
					"order": 0,
					"source": ["obj-6", 0]
				}
			...
			},
			{
				"patchline": {
					"destination": ["obj-14", 0],
					"midpoints": [1203.5, 88.5, 859.500000000000114, 88.5],
					"order": 1,
					"source": ["obj-87", 0]
				}
			},
			{
				"patchline": {
					...
					"midpoints": [1203.5, 88.5, 1013.500000000000114, 88.5],
					"order": 0,
					"source": ["obj-87", 0]
				}
			},
			{
				"patchline": {
					...
					"midpoints": [1203.5, 88.5, 705.500000000000114, 88.5],
					"order": 2,
					"source": ["obj-87", 0]
				}
			},
			...
			},
			{
				"patchline": {
					"destination": ["obj-55", 0],
					"midpoints": [499.166670799255371, 460.666679501533508, 360.5, 460.666679501533508],
					"source": ["obj-90", 0]
				}
			},
			{
