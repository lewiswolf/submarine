{
	"patcher": {
		...
		"parameters": {
			"obj-36": ["mix", "Dry / Wet", 0],
			"obj-41": ["pitch_shift", "Pitch Shift", 0],
			"obj-45": ["vibrato_amount", "Vibrato Amt", 0],
			"obj-6": ["tuning", "tuning_preset", 0],
			"obj-63": ["vibrato_rate", "Vibrato Rate", 0],
			"parameterbanks": {
				"0": {
					"index": 0,
					"name": "",
