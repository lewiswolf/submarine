		...
		"boxes": [
			{
				"box": {
					...
					"outlettype": ["", "bang"],
					"parameter_enable": 1,
					"patching_rect": [617.0, 446.0, 50.0, 20.0],
					"presentation": 1,
			...
			},
			{
				"box": {
					...
					"outlettype": ["", "bang"],
					"parameter_enable": 1,
					"patching_rect": [533.0, 446.0, 50.0, 20.0],
					"presentation": 1,
			...
			},
			{
				"box": {
					...
					"numinlets": 1,
					"numoutlets": 0,
					"patching_rect": [669.0, 446.0, 31.0, 20.0],
					"presentation": 1,
			...
			},
			{
				"box": {
					...
					"numinlets": 1,
					"numoutlets": 0,
					"patching_rect": [585.0, 446.0, 28.0, 20.0],
					"presentation": 1,
			...
			},
			{
				"box": {
					...
					"numoutlets": 2,
					"outlettype": ["", ""],
					"patching_rect": [590.0, 211.0, 43.0, 22.0],
					"text": "list.rev"
				}
			},
			{
			...
			},
			{
				"box": {
					...
					"outlettype": ["", ""],
					"parameter_enable": 1,
					"patching_rect": [590.0, 165.0, 66.0, 41.0],
					"presentation": 1,
			...
			},
			{
				"box": {
					...
					"patching_rect": [590.0, 237.0, 107.0, 22.0],
			...
			},
			{
				"box": {
					...
					"numoutlets": 1,
					"outlettype": ["signal"],
					"patching_rect": [627.0, 272.0, 58.0, 22.0],
					"text": "mc.sum~"
				}
			},
			{
				"box": {
					...
					"numoutlets": 1,
					"outlettype": ["multichannelsignal"],
					"patching_rect": [552.0, 301.0, 94.0, 49.0],
					"text": "mc.gen~ number-input @chans 6"
				}
			},
			{
			...
			},
			{
				"box": {
					...
					"numoutlets": 1,
					"outlettype": [""],
					"patching_rect": [552.0, 227.0, 30.0, 30.0]
				}
			},
			{
				"box": {
		...
		"lines": [
			...
			},
			{
				"patchline": {
					...
					"midpoints": [561.5, 264.0, 636.5, 264.0],
					"order": 0,
					"source": ["obj-40", 0]
				}
			},
