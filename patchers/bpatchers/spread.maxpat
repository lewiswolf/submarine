	...
	"patcher": {
		...
		"boxes": [
			{
				"box": {
					...
					"numinlets": 1,
					"numoutlets": 0,
					"patching_rect": [28.0, 27.0, 268.0, 22.0],
			...
			},
			{
				"box": {
					...
					"numoutlets": 1,
					"outlettype": ["int"],
					"patching_rect": [28.0, 143.0, 22.0, 22.0],
					"text": "t 0"
				}
			},
			{
				"box": {
					...
					"numoutlets": 1,
					"outlettype": [""],
					"patching_rect": [28.0, 258.0, 42.0, 22.0],
					"text": "mute~"
				}
			},
			{
				"box": {
					...
					"outlettype": ["", "", "int"],
					"parameter_enable": 0,
					"patching_rect": [28.0, 227.0, 67.0, 20.0],
					"presentation": 1,
			...
			},
			{
				"box": {
						...
						"boxes": [
							{
								"box": {
									...
									"patching_rect": [505.5, 129.37383231520653, 29.5, 22.0],
									"text": "gen"
								}
							},
							{
								"box": {
									...
									"numoutlets": 1,
									"outlettype": ["float"],
									"patching_rect": [472.5, 129.37383231520653, 25.0, 22.0],
									"text": "t 1."
								}
							},
							{
							...
							},
							{
								"box": {
									...
									"numoutlets": 1,
									"outlettype": ["multichannelsignal"],
									"patching_rect": [50.0, 227.37383231520653, 556.0280376076698, 22.0],
									"text": "mc.round~"
								}
							},
							{
							...
							},
							{
								"box": {
									...
									"numoutlets": 1,
									"outlettype": ["multichannelsignal"],
									"patching_rect": [50.0, 160.37383231520653, 120.0, 22.0],
							...
							},
							{
								"box": {
									...
									"numoutlets": 1,
									"outlettype": ["multichannelsignal"],
									"patching_rect": [50.0, 191.37383231520653, 439.8855112940074, 22.0],
							...
							},
							{
								"box": {
									...
									"numoutlets": 1,
									"outlettype": ["multichannelsignal"],
									"patching_rect": [50.0, 129.37383231520653, 107.0, 22.0],
							...
							},
							{
								"box": {
									...
									"numoutlets": 1,
									"outlettype": [""],
									"patching_rect": [49.999999607669835, 40.00000731520652, 30.0, 30.0]
								}
							},
							{
								"box": {
									...
									"numoutlets": 1,
									"outlettype": [""],
									"patching_rect": [301.9999916076698, 40.00000731520652, 30.0, 30.0]
								}
							},
							{
								"box": {
									...
									"numoutlets": 1,
									"outlettype": [""],
									"patching_rect": [385.9999916076698, 40.00000731520652, 30.0, 30.0]
								}
							},
							{
								"box": {
									...
									"numoutlets": 1,
									"outlettype": [""],
									"patching_rect": [472.4999916076698, 40.00000731520652, 30.0, 30.0]
								}
							},
							{
								"box": {
									...
									"numoutlets": 1,
									"outlettype": [""],
									"patching_rect": [587.0000226076698, 40.00000731520652, 30.0, 30.0]
								}
							},
							{
								"box": {
									...
									"numinlets": 1,
									"numoutlets": 0,
									"patching_rect": [49.999999607669835, 309.3738323152065, 30.0, 30.0]
								}
							}
						],
						"lines": [
					...
					"patching_rect": [108.0, 293.0, 675.0, 22.0],
					"text": "p dsp"
				}
			},
			{
			...
			},
			{
				"box": {
					...
					"outlettype": ["", "bang"],
					"parameter_enable": 1,
					"patching_rect": [272.0, 259.0, 50.0, 20.0],
					"presentation": 1,
			...
			},
			{
				"box": {
					...
					"numoutlets": 1,
					"outlettype": ["int"],
					"patching_rect": [764.0, 143.0, 22.0, 22.0],
					"text": "t 0"
				}
			},
			{
				"box": {
					...
					"outlettype": ["", "", "int"],
					"parameter_enable": 1,
					"patching_rect": [600.0, 259.0, 100.0, 20.0],
					"presentation": 1,
			...
			},
			{
				"box": {
					...
					"outlettype": ["", "", "int"],
					"parameter_enable": 1,
					"patching_rect": [764.0, 259.0, 100.0, 20.0],
					"presentation": 1,
			...
			},
			{
				"box": {
					...
					"patching_rect": [108.0, 94.0, 58.0, 22.0],
					"text": "p presets"
				}
			},
			{
				"box": {
					...
					"outlettype": ["int", "", ""],
					"parameter_enable": 0,
					"patching_rect": [108.0, 58.0, 100.0, 20.0],
					"presentation": 1,
			...
			},
			{
				"box": {
					...
					"numoutlets": 1,
					"outlettype": [""],
					"patching_rect": [722.0, 48.0, 30.0, 30.0]
				}
			},
			{
				"box": {
					...
					"numoutlets": 2,
					"outlettype": ["", ""],
					"patching_rect": [108.0, 143.0, 151.0, 22.0],
					"text": "list.reg 0. 0.2 0.4 0.6 0.8 1."
				}
			},
			{
				"box": {
					...
					"patching_rect": [272.0, 143.0, 183.0, 22.0],
					"text": "t 0. 1."
				}
			},
			{
				"box": {
					...
					"numinlets": 1,
					"numoutlets": 0,
					"patching_rect": [488.0, 259.0, 31.0, 20.0],
					"presentation": 1,
			...
			},
			{
				"box": {
					...
					"numinlets": 1,
					"numoutlets": 0,
					"patching_rect": [324.0, 259.0, 28.0, 20.0],
					"presentation": 1,
			...
			},
			{
				"box": {
					...
					"numoutlets": 4,
					"outlettype": ["", "", "", ""],
					"patching_rect": [796.0, 143.0, 56.0, 22.0],
					"restore": {
						"bypass": [1],
			...
			},
			{
				"box": {
					...
					"numoutlets": 1,
					"outlettype": [""],
					"patching_rect": [805.0, 48.0, 58.0, 22.0],
					"text": "loadbang"
				}
			},
			{
				"box": {
					...
					"numoutlets": 1,
					"outlettype": [""],
					"patching_rect": [764.0, 48.0, 30.0, 30.0]
				}
			},
			{
				"box": {
					...
					"numoutlets": 1,
					"outlettype": ["bang"],
					"patching_rect": [891.0, 143.0, 22.0, 22.0],
					"text": "t b"
				}
			},
			{
				"box": {
					...
					"numoutlets": 3,
					"outlettype": ["", "", ""],
					"patching_rect": [764.0, 94.0, 273.0, 22.0],
			...
			},
			{
				"box": {
					...
					"numoutlets": 1,
					"outlettype": [""],
					"patching_rect": [891.0, 179.0, 113.02803683280945, 62.0],
			...
			},
			{
				"box": {
					...
					"numinlets": 1,
					"numoutlets": 0,
					"patching_rect": [28.0, 7.0, 48.0, 18.0],
					"presentation": 1,
			...
			},
			{
				"box": {
					...
					"numinlets": 1,
					"numoutlets": 0,
					"patching_rect": [962.0, 66.0, 42.0, 21.0],
					"presentation": 1,
			...
			},
			{
				"box": {
					...
					"numinlets": 1,
					"numoutlets": 0,
					"patching_rect": [108.0, 330.0, 30.0, 30.0]
				}
			},
			{
				"box": {
					...
					"outlettype": ["", ""],
					"parameter_enable": 1,
					"patching_rect": [108.0, 179.0, 124.0, 100.0],
					"presentation": 1,
			...
			},
			{
				"box": {
					...
					"numinlets": 1,
					"numoutlets": 0,
					"patching_rect": [1001.0, 66.0, 37.0, 21.0],
					"presentation": 1,
		...
		"lines": [
			...
			},
			{
				"patchline": {
					"destination": ["obj-20", 0],
					"midpoints": [37.5, 286.0, 117.5, 286.0],
					"source": ["obj-43", 0]
				}
			},
			{
			...
			},
			{
				"patchline": {
					...
					"midpoints": [814.5, 84.5, 773.5, 84.5],
					"source": ["obj-82", 0]
				}
			},
			{
			...
			},
			{
				"patchline": {
					"destination": ["obj-21", 0],
					"midpoints": [773.5, 129.0, 37.5, 129.0],
					"order": 3,
					"source": ["obj-87", 0]
				}
			},
			{
				"patchline": {
					...
					"midpoints": [773.5, 129.1074762046337, 281.5, 129.1074762046337],
					"order": 1,
					"source": ["obj-87", 0]
				}
			},
			{
				"patchline": {
					...
					"midpoints": [773.5, 129.1074762046337, 117.5, 129.1074762046337],
					"order": 2,
					"source": ["obj-87", 0]
				}
			},
			...
			},
			{
				"patchline": {
					"destination": ["obj-11", 0],
					"midpoints": [773.5, 174.25233536958694, 609.5, 174.25233536958694],
					"order": 1,
					"source": ["obj-9", 0]
				}
			},
